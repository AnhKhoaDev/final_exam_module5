            ...
            <>
                ...
                <Form className="container mt-3">
                    <div className="form-group mb-3">
                        <label htmlFor="code" className="mb-1 fw-bold">Mã sản phẩm</label>
                        <Field name="code" className="form-control"/>
                        <ErrorMessage name="code" component="div" className="text-danger"/>
                    </div>

                    <div className="form-group mb-3">
                        <label htmlFor="name" className="mb-1 fw-bold">Tên sản phẩm</label>
                        <Field name="name" className="form-control"/>
                        <ErrorMessage name="name" component="div" className="text-danger"/>
                    </div>

                    <div className="form-group mb-3">
                        <label htmlFor="category" className="mb-1 fw-bold">Thể loại</label>
                    ...
                    <div className="form-group mb-3">
                        <label htmlFor="price" className="mb-1 fw-bold">Giá</label>
                        <Field name="price" type="number" className="form-control"/>
                        <ErrorMessage name="price" component="div" className="text-danger"/>
                    </div>

                    <div className="form-group mb-3">
                        <label htmlFor="quantity" className="mb-1 fw-bold">Số lượng</label>
                        <Field name="quantity" type="number" className="form-control"/>
                        <ErrorMessage name="quantity" component="div" className="text-danger"/>
                    </div>

                    <div className="form-group mb-3">
                        <label htmlFor="date" className="mb-1 fw-bold">Ngày nhập sản phẩm</label>
                        <Field name="date" type="date" className="form-control"/>
                        <ErrorMessage name="date" component="div" className="text-danger"/>
                    </div>

                    <div className="form-group mb-3">
                        <label htmlFor="description" className="mb-1 fw-bold">Mô tả sản phẩm</label>
                        <Field name="description" as="textarea" className="form-control"/>
                        <ErrorMessage name="description" component="div" className="text-danger"/>
                    </div>

                    <button type="submit" className="btn btn-primary fw-bold">Thêm mới</button>
                </Form>
            </>
        </Formik>
    )
